...
WITH m, d, s, saude, (coalesce(a.v00644, 0) - (coalesce(a.v00657, 0) + coalesce(a.v00658, 0) + coalesce(a.v00659, 0) + coalesce(a.v00660, 0) + coalesce(a.v00661, 0))) AS jovens_analfabetos
